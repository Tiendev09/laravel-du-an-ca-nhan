        ...
        <div class="secion" id="breadcrumb-wp">
            <div class="secion-detail">
                ...
                <ul class="list-item clearfix">
                    ...
                    <li>
                        <a href="{{route('product_cat',[$product_cats->slug,$brands->slug])}}" title="">{{$product_cats->name}}</a>
                    </li>
                    <li>
                        <a href="" title="">{{$brands->name}}</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="main-content fl-right">
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    <h3 class="section-title fl-left">{{$brands->name}}</h3>
                    <div class="filter-wp fl-right">
                        <p class="desc">Hiện có {{count($brands->products)}} sản phẩm</p>
                        <div class="form-filter">
                            <form action="{{route('product.action.brand',[$product_cats->slug,$brands->slug])}}">
                                <select name="act">
                    ...
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            ...
                            <div class="action clearfix">
                                ...
                                <a href="{{route('buy_now',[$item->slug])}}" title="Mua ngay" class="buy-now fl-right">Mua ngay</a>
                            </div>
                        </li>
                        @endforeach
                    </ul>
